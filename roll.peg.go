...
var g = &grammar{
	rules: []*rule{
				...
				alternatives: []any{
					&seqExpr{
						exprs: []any{
							...
							&ruleIRefExpr{index: 129 /* st_expr */},
						},
					},
		...
		},
		{
			...
			expr: &choiceExpr{
				alternatives: []any{
					...
					&seqExpr{
						exprs: []any{
							&ruleIRefExpr{index: 126 /* comment */},
							&ruleIRefExpr{index: 122 /* sp */},
							&zeroOrOneExpr{
								expr: &ruleIRefExpr{index: 3 /* stmtLines */},
							},
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					exprs: []any{
						...
						&labeledExpr{
							label: "id",
							expr:  &ruleIRefExpr{index: 97 /* identifier */},
						},
						&ruleIRefExpr{index: 124 /* sp1x */},
						&labeledExpr{
							label: "on",
						...
						&ruleIRefExpr{index: 127 /* commentLineRest */},
					},
				},
			},
		},
							...
							&choiceExpr{
								alternatives: []any{
									...
									&actionExpr{
										...
										expr: &ruleIRefExpr{index: 122 /* sp */},
									},
								},
							},
						},
							...
							exprs: []any{
								&actionExpr{
									...
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 122 /* sp */},
											&ruleIRefExpr{index: 114 /* logicOr */},
										},
									},
								},
								&actionExpr{
					...
					&zeroOrMoreExpr{
						expr: &actionExpr{
							...
							expr: &seqExpr{
								exprs: []any{
									&ruleIRefExpr{index: 122 /* sp */},
									&ruleIRefExpr{index: 115 /* logicAnd */},
									&ruleIRefExpr{index: 37 /* exprBitwiseOr */},
								},
							},
						},
							...
							&zeroOrMoreExpr{
								expr: &actionExpr{
									...
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 122 /* sp */},
											&ruleIRefExpr{index: 112 /* bitwiseOr */},
											&ruleIRefExpr{index: 38 /* exprBitwiseAnd */},
										},
									},
								},
					...
					&zeroOrMoreExpr{
						expr: &actionExpr{
							...
							expr: &seqExpr{
								exprs: []any{
									&ruleIRefExpr{index: 122 /* sp */},
									&ruleIRefExpr{index: 113 /* bitwiseAnd */},
									&ruleIRefExpr{index: 39 /* exprCompare */},
								},
							},
						},
								...
								&choiceExpr{
									alternatives: []any{
										&actionExpr{
											...
											expr: &seqExpr{
												exprs: []any{
													&ruleIRefExpr{index: 107 /* multiply */},
										...
										&actionExpr{
											...
											expr: &seqExpr{
												exprs: []any{
													&ruleIRefExpr{index: 109 /* modulus */},
													&ruleIRefExpr{index: 43 /* exprExp */},
												},
											},
										},
					...
					&zeroOrMoreExpr{
						expr: &actionExpr{
							...
							expr: &seqExpr{
								exprs: []any{
									&ruleIRefExpr{index: 122 /* sp */},
									&ruleIRefExpr{index: 111 /* nullCoalescing */},
									&ruleIRefExpr{index: 43 /* exprExp */},
								},
							},
						},
					...
					&zeroOrMoreExpr{
						expr: &actionExpr{
							...
							expr: &seqExpr{
								exprs: []any{
									&ruleIRefExpr{index: 122 /* sp */},
									&ruleIRefExpr{index: 110 /* exponentiation */},
									&ruleIRefExpr{index: 44 /* exprUnaryNeg */},
								},
							},
						},
		...
		},
		{
			...
			expr: &choiceExpr{
				alternatives: []any{
					&ruleIRefExpr{index: 81 /* number */},
					&ruleIRefExpr{index: 101 /* sub */},
				},
			},
		},
		{
				...
				exprs: []any{
					...
					&choiceExpr{
						alternatives: []any{
							...
							&litMatcher{val: "劣勢", want: "\"劣勢\""},
							&notExpr{
								expr: &ruleIRefExpr{index: 99 /* xidStart */},
							},
						},
					},
				},
				...
				alternatives: []any{
					...
					&seqExpr{
						exprs: []any{
							&ruleIRefExpr{index: 61 /* _wodTypeMain */},
							&notExpr{
								expr: &ruleIRefExpr{index: 100 /* xidContinue */},
							},
						},
					},
				},
							...
							&choiceExpr{
								alternatives: []any{
									&actionExpr{
										...
										expr: &ruleIRefExpr{index: 81 /* number */},
									},
									&codeExpr{
			...
			expr: &zeroOrMoreExpr{
				expr: &seqExpr{
					exprs: []any{
						...
						&zeroOrOneExpr{
							expr: &ruleIRefExpr{index: 75 /* func_invoke */},
						},
					},
				},
			},
					...
					exprs: []any{
						&seqExpr{
							exprs: []any{
								&choiceExpr{
									alternatives: []any{
										&ruleIRefExpr{index: 77 /* value_id_without_colon */},
										&ruleIRefExpr{index: 26 /* exprRoot */},
									},
								},
								&ruleIRefExpr{index: 122 /* sp */},
					...
					&actionExpr{
						...
						expr: &seqExpr{
							exprs: []any{
								&labeledExpr{
									label: "id",
									expr:  &ruleIRefExpr{index: 98 /* identifierWithoutColon */},
								},
								&ruleIRefExpr{index: 122 /* sp */},
							},
						},
			...
			expr: &choiceExpr{
				alternatives: []any{
								...
								expr: &seqExpr{
									exprs: []any{
										&andExpr{
											expr: &seqExpr{
												exprs: []any{
													&ruleIRefExpr{index: 97 /* identifier */},
													&ruleIRefExpr{index: 125 /* spNoCR */},
												},
											},
										},
					...
					&seqExpr{
						exprs: []any{
							&andExpr{
								expr: &ruleIRefExpr{index: 78 /* value_array_range */},
							},
							&ruleIRefExpr{index: 78 /* value_array_range */},
							&zeroOrOneExpr{
								expr: &ruleIRefExpr{index: 70 /* array_call */},
							},
							&ruleIRefExpr{index: 74 /* attr_get */},
					...
					&seqExpr{
						exprs: []any{
							&andExpr{
								expr: &ruleIRefExpr{index: 79 /* value_array */},
							},
							&ruleIRefExpr{index: 79 /* value_array */},
							&zeroOrOneExpr{
								expr: &ruleIRefExpr{index: 70 /* array_call */},
							},
							&ruleIRefExpr{index: 74 /* attr_get */},
					...
					&seqExpr{
						exprs: []any{
							...
							&actionExpr{
								...
								expr: &seqExpr{
									exprs: []any{
										&ruleIRefExpr{index: 76 /* dict_item */},
										&zeroOrMoreExpr{
											expr: &seqExpr{
												exprs: []any{
													&litMatcher{val: ",", want: "\",\""},
			...
			expr: &actionExpr{
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 91 /* strEscape */},
								&ruleIRefExpr{index: 84 /* strPart1Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 91 /* strEscape */},
								&ruleIRefExpr{index: 86 /* strPart2Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 91 /* strEscape */},
								&ruleIRefExpr{index: 88 /* strPart3Normal */},
							},
						},
					},
				},
				...
				expr: &labeledExpr{
					...
					expr: &oneOrMoreExpr{
						expr: &choiceExpr{
							alternatives: []any{
								&ruleIRefExpr{index: 91 /* strEscape */},
								&ruleIRefExpr{index: 90 /* strPart4Normal */},
							},
						},
					},
				},
								...
								exprs: []any{
									...
									&actionExpr{
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &ruleIRefExpr{index: 83 /* strPart1 */},
												},
												&litMatcher{val: "'", want: "\"'\""},
											},
										},
								...
								exprs: []any{
									...
									&actionExpr{
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &ruleIRefExpr{index: 85 /* strPart2 */},
												},
												&litMatcher{val: "\"", want: "\"\\\"\""},
											},
										},
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &choiceExpr{
														alternatives: []any{
															&ruleIRefExpr{index: 87 /* strPart3 */},
															&ruleIRefExpr{index: 92 /* fstringStmt */},
															&ruleIRefExpr{index: 93 /* fstringStmt2 */},
														},
													},
												},
												&litMatcher{val: "`", want: "\"`\""},
										...
										expr: &seqExpr{
											exprs: []any{
												&zeroOrMoreExpr{
													expr: &choiceExpr{
														alternatives: []any{
															&ruleIRefExpr{index: 89 /* strPart4 */},
															&ruleIRefExpr{index: 92 /* fstringStmt */},
															&ruleIRefExpr{index: 93 /* fstringStmt2 */},
														},
													},
		...
		},
		{
			...
			expr: &notExpr{
				expr: &seqExpr{
					exprs: []any{
						&ruleIRefExpr{index: 95 /* keywords */},
						&notExpr{
							expr: &ruleIRefExpr{index: 100 /* xidContinue */},
						},
		...
		},
		{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					exprs: []any{
						&ruleIRefExpr{index: 96 /* keywords_test */},
						&ruleIRefExpr{index: 99 /* xidStart */},
						&zeroOrMoreExpr{
							expr: &choiceExpr{
								alternatives: []any{
									&ruleIRefExpr{index: 100 /* xidContinue */},
									&litMatcher{val: ":", want: "\":\""},
								},
							},
						},
		...
		},
		{
			...
			expr: &seqExpr{
				exprs: []any{
					&ruleIRefExpr{index: 103 /* parenOpen */},
					&ruleIRefExpr{index: 26 /* exprRoot */},
					&ruleIRefExpr{index: 104 /* parenClose */},
				},
			},
		},
		{
		...
		},
		{
			...
			expr: &choiceExpr{
				alternatives: []any{
					&ruleIRefExpr{index: 134 /* st_modify_multi_1 */},
					&ruleIRefExpr{index: 131 /* st_assign_multi */},
				},
			},
		},
		{
		...
		},
		{
			...
			expr: &oneOrMoreExpr{
				expr: &seqExpr{
					exprs: []any{
						&ruleIRefExpr{index: 133 /* st_assign */},
						&ruleIRefExpr{index: 122 /* sp */},
						&zeroOrOneExpr{
							expr: &litMatcher{val: ",", want: "\",\""},
						},
						...
						expr: &seqExpr{
							exprs: []any{
								&andExpr{
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 141 /* st_name2 */},
											&ruleIRefExpr{index: 122 /* sp */},
											&choiceExpr{
												alternatives: []any{
													&litMatcher{val: ":", want: "\":\""},
						...
						expr: &seqExpr{
							exprs: []any{
								&andExpr{
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 139 /* st_name1 */},
											&ruleIRefExpr{index: 130 /* est */},
										},
									},
								},
						...
						expr: &seqExpr{
							exprs: []any{
								&andExpr{
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 142 /* st_name2r */},
											&ruleIRefExpr{index: 122 /* sp */},
											&ruleIRefExpr{index: 132 /* st_star */},
											&ruleIRefExpr{index: 122 /* sp */},
											&choiceExpr{
												alternatives: []any{
													&litMatcher{val: ":", want: "\":\""},
						...
						expr: &seqExpr{
							exprs: []any{
								&andExpr{
									expr: &seqExpr{
										exprs: []any{
											&ruleIRefExpr{index: 140 /* st_name1r */},
											&ruleIRefExpr{index: 130 /* est */},
										},
									},
								},
					...
					&seqExpr{
						exprs: []any{
							...
							&actionExpr{
								...
								expr: &labeledExpr{
									label:       "text",
									expr:        &ruleIRefExpr{index: 130 /* est */},
									textCapture: true,
								},
							},
						},
		...
		},
		{
			...
			expr: &seqExpr{
				exprs: []any{
					&seqExpr{
						exprs: []any{
							&ruleIRefExpr{index: 135 /* st_modify_lead */},
							&ruleIRefExpr{index: 122 /* sp */},
							&zeroOrOneExpr{
								expr: &litMatcher{val: ",", want: "\",\""},
							},
					...
					&ruleIRefExpr{index: 136 /* st_modify_multi_rest */},
				},
			},
		},
		{
						...
						exprs: []any{
							&andExpr{
								expr: &seqExpr{
									exprs: []any{
										&ruleIRefExpr{index: 141 /* st_name2 */},
										&ruleIRefExpr{index: 137 /* st_modify_rest1 */},
									},
								},
							},
							&ruleIRefExpr{index: 141 /* st_name2 */},
						...
						exprs: []any{
							&andExpr{
								expr: &seqExpr{
									exprs: []any{
										&ruleIRefExpr{index: 139 /* st_name1 */},
										&ruleIRefExpr{index: 138 /* st_modify_rest */},
									},
								},
							},
							&ruleIRefExpr{index: 139 /* st_name1 */},
			...
			expr: &actionExpr{
				...
				expr: &labeledExpr{
					...
					expr: &seqExpr{
						exprs: []any{
							&oneOrMoreExpr{
								expr: &ruleIRefExpr{index: 143 /* id_ch */},
							},
							&litMatcher{val: ":", want: "\":\""},
							&oneOrMoreExpr{
								expr: &ruleIRefExpr{index: 143 /* id_ch */},
		...
		{
			name: "st_name2",
			expr: &ruleIRefExpr{index: 139 /* st_name1 */},
		},
		{
			name:      "st_name2r",
			varExists: true,
